...
public sealed class MainApiSyncClient
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (payload is null)
        {
            throw new InvalidOperationException("Machine validation API returned an empty response.");
        }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (payload is null)
        {
            throw new InvalidOperationException("Upload query API returned an empty response.");
        }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (payload is null)
        {
            throw new InvalidOperationException("Upload detail API returned an empty response.");
        }
    ...
    private async Task EnsureSessionAsync(MainApiConfiguration configuration, CancellationToken cancellationToken)
    {
        ...
        {
            throw new InvalidOperationException("MainApi linkage configuration is incomplete: base URL, login name, and password are required.");
        }
        ...
        {
            throw new InvalidOperationException("Machine code is not registered.");
        }

        if (!machineStatus.IsActive)
        {
            throw new InvalidOperationException("Machine code is disabled.");
        }
        ...
        {
            throw new InvalidOperationException("MainApi login succeeded but user information was empty.");
        }
    ...
    private async Task<LoginResponse> LoginAsync(MainApiConfiguration configuration, CancellationToken cancellationToken)
    {
        ...
        if (payload is null)
        {
            throw new InvalidOperationException("MainApi login API returned an empty response.");
        }
    ...
    private static async Task EnsureSuccessAsync(HttpResponseMessage response, CancellationToken cancellationToken)
    {
        ...
        throw new InvalidOperationException($"MainApi request failed: {(int)response.StatusCode} {response.ReasonPhrase}");
    }
